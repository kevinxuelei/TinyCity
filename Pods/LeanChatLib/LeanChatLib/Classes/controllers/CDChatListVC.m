...
//        [cell.avatarImageView setImageWithURL:[NSURL URLWithString:@"http://img0.imgtn.bdimg.com/it/u=2596087373,2714370257&fm=21&gp=0.jpg"] placeholer:nil];
        [cell.avatarImageView setImage:[UIImage imageNamed:@"100008888258360"]];
    }
    else {
